...
sigma = [-2 -1.8 -1.6 -1.4 -1.2 -1 -0.8 -0.6 -0.4 -0.2 0 0.2 0.4 0.6 0.8 1 1.2 1.4 1.6 1.8 2];
lsigma = size(sigma,2);
VtISA = zeros(6,lsigma);
startingFrame = 11;
lastFrame = 28;
...
for i = 1:lsigma
    ...
    fulltac = dlmread(['Data/TACs/pabloModel/0noise0vb/fullTAC' num2str(sigma(i)) 'sigma.tac'], '\t', 1, 0);
    ...
    sourceCp = dlmread(['Data/Cps/pabloModel/pabloModel_' num2str(sigma(i)) 'sigma.smpl'], '\t', 1, 0);
